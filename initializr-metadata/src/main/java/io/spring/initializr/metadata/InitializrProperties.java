...
public class InitializrProperties extends InitializrConfiguration {
    ...
    private final SimpleElement jdbcUrl = new SimpleElement(null);
    private final SimpleElement userName = new SimpleElement(null);
    private final SimpleElement password = new SimpleElement(null);
    ...
    public SimpleElement getJdbcUrl() {
        return jdbcUrl;
    }

    public SimpleElement getUserName() {
        return userName;
    }

    public SimpleElement getPassword() {
        return password;
    }
